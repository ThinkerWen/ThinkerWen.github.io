...
<img src="https://www.hive-net.cn/funtools/i/Ek19DFSk" width="200" alt="CrackMe" />
...
<img src="https://www.hive-net.cn/funtools/i/abvTsy7Z" width="500" alt="CrackMe" />

进入`FlagGuard().getFlag()`，发现只要传入的`str`(即输入的`password`)与`Data().getData()`相等就会返回②所计算出的flag，现在只需要看`Data().getData()`就可以拿到密码。

<img src="https://www.hive-net.cn/funtools/i/jPZMjxWd" width="500" alt="CrackMe" />

进入`Data().getData()`，发现函数直接返回了`password`字符串`s3cr37_p4ssw0rd_1337`。

<img src="https://www.hive-net.cn/funtools/i/3ogFg6up" width="500" alt="CrackMe" />

在文本框输入`s3cr37_p4ssw0rd_1337`即可拿到`flag`。

<img src="https://www.hive-net.cn/funtools/i/I9jBKs0T" width="200" alt="CrackMe" />