...
<img src="https://www.hive-net.cn/funtools/i/FOuTazdY" width="200" alt="CrackMe" />
...
<img src="https://www.hive-net.cn/funtools/i/oc0P7sEg" width="500" alt="CrackMe" />

进入 `FlagGuard().getFlag()`，发现只要传入的 `str`(即输入的 `password`)与 `Data().getData(context)`相等就会返回②所计算出的flag，现在只需要看 `Data().getData()`就可以拿到密码。

<img src="https://www.hive-net.cn/funtools/i/THJJqDOx" width="500" alt="CrackMe" />

进入 `Data().getData()`，发现函数需要获取到 `ApplicationContext`中的字符串来当做 `password`。

<img src="https://www.hive-net.cn/funtools/i/dADaMlEz" width="500" alt="CrackMe" />

追踪进去后我们发现R.string.secret的值是一个地址，这显然不是明文密码，那么我该何看到密码呢？

<img src="https://www.hive-net.cn/funtools/i/aHwcfv5p" width="500" alt="CrackMe" />
...
<img src="https://www.hive-net.cn/funtools/i/3dASb0Qf" width="500" alt="CrackMe" />

在文本框输入 `s0m3_0th3r_s3cr3t_passw0rd`即可拿到 `flag`。

<img src="https://www.hive-net.cn/funtools/i/YllrqwcG" width="200" alt="CrackMe" />