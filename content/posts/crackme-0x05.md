...
<div style="display: flex; align-items: flex-start; gap: 10px;">  <img src="https://www.hive-net.cn/funtools/i/USyXWpnm" width="200" alt="CrackMe" /> <img src="https://www.hive-net.cn/funtools/i/GmfgHQgS" width="200" alt="CrackMe" /></div>

用Jadx-GUI打开APK看一下源码，在打开APP后先执行①，通过`MyApp.m`来判断APP的注册状态。
在②中判断注册状态，如果未注册则执行③的`doRegister()`，如果已经注册则执行`MyApp.work()`

<img src="https://www.hive-net.cn/funtools/i/GqIvNPCL" width="500" alt="CrackMe" />
...
<img src="https://www.hive-net.cn/funtools/i/tk61aoLw" width="500" alt="CrackMe" />

我们再看输入注册码后的`doRegister()`,他将输入的注册码sn作为参数传入到了`MyApp.saveSN()`中，且`MyApp.saveSN()`也是native函数，所以我们只需要看`hack`的so即可。

<img src="https://www.hive-net.cn/funtools/i/5dUhb9ar" width="500" alt="CrackMe" />

打开IDA工具找对应的native方法。
找到`work()`方法对应的native方法`n3`后发现想要注册为企业版，则使用到了`n1`方法

<img src="https://www.hive-net.cn/funtools/i/8kggjzUm" width="500" alt="CrackMe" />
...
<img src="https://www.hive-net.cn/funtools/i/XC0IdPS5" width="500" alt="CrackMe" />

再看`saveSN()`对应的`n2`方法，它将输入的字符串做md5加密然后存储到`/sdcard/reg.dat`中

<img src="https://www.hive-net.cn/funtools/i/EWg1yJwX" width="500" alt="CrackMe" />
...
<img src="https://www.hive-net.cn/funtools/i/FSVo48a2" width="500" alt="CrackMe" />

输入注册码保存成功，再打开APP则已经注册为企业版了

<img src="https://www.hive-net.cn/funtools/i/1yZi0R6X" width="200" alt="CrackMe" />